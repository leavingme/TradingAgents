...
`architecture-run-cost-rollup/v1`：从最多 5000 个最新终态 run 汇总架构 fingerprint、
分析日期范围、completed/review_required/unavailable/failed/cancelled 状态、stats 覆盖、
总成本及 Agent/工具热点。该时间轴不要求市场结果成熟，因此下一次日跑结束后即可用于
