...
const translations = {
  en: {
    ...
    costRuns: 'Cost runs',
    experimentPilot: 'Experiment pilot',
    ...
    experimentMembershipExclusions: 'Experiment membership exclusions',
    ...
    evaluationCodePilotCollecting: 'Collecting',
    evaluationCodePilotPassed: 'Passed',
    evaluationCodePilotFailed: 'Failed',
  ...
  zh: {
    ...
    validPairs: '有效配对',
    experimentPlan: '实验计划',
    experimentMembershipExclusions: '实验成员关系排除数',
    ...
    evaluationCodePilotCollecting: '收集中',
    evaluationCodePilotPassed: '已通过',
    evaluationCodePilotFailed: '已失败',
